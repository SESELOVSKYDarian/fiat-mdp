    ...
    <main>
      <section className="legacy-hero gsap-reveal">
        <div className="legacy-hero-content" data-speed="0.95">
          <h1 className="impact-title legacy-title-xl gsap-reveal-text">
            Viví la pasión y <span style={{ color: "#36c3f2" }}>ganá con Fiat</span>
          </h1>
          <p className="legacy-subtitle gsap-reveal-text">
            La Copa Argentina se vive diferente arriba de un Fiat. Participá por experiencias únicas, premios exclusivos y el
            auto de tus sueños.
          </p>
      ...
      <section className="legacy-steps gsap-reveal">
        <div className="container">
          <h2 className="impact-title legacy-section-title gsap-reveal-text">¿Cómo participar?</h2>
          <div className="legacy-step-underline" />
          <div className="legacy-steps-grid">
            <SpotlightCard className="legacy-step-card gsap-reveal" spotlightColor="rgba(54, 195, 242, 0.22)">
              ...
              <p>Creá tu perfil oficial y vinculá tus datos para empezar a sumar chances en cada partido.</p>
            </SpotlightCard>
            <SpotlightCard className="legacy-step-card gsap-reveal" spotlightColor="rgba(249, 237, 61, 0.16)">
              <div className="legacy-step-icon" aria-hidden="true">
                <svg viewBox="0 0 24 24">
              ...
              <p>Sumate a las promociones vigentes durante los encuentros de la Copa Argentina.</p>
            </SpotlightCard>
            <SpotlightCard className="legacy-step-card gsap-reveal" spotlightColor="rgba(237, 26, 107, 0.18)">
              <div className="legacy-step-icon" aria-hidden="true">
                <svg viewBox="0 0 24 24">
              ...
              <p>Revisá los ganadores publicados y seguí participando en cada nuevo sorteo disponible.</p>
            </SpotlightCard>
          </div>
        </div>
      </section>
            ...
            {prizeCards.map((card) => (
              ...
              >
                ...
                <div className="legacy-prize-overlay">
                  <h3 className="impact-title legacy-prize-title">{card.title}</h3>
                  <p>{card.subtitle}</p>
                </div>
              </article>
            ))}
      ...
      <section className="legacy-home-cta gsap-reveal">
        <h3 className="impact-title legacy-section-title gsap-reveal-text">¿Qué estás esperando?</h3>
